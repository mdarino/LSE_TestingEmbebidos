...
typedef enum
{
	CUR_STATUS_OFF = 0, /**< It is OFF because the output is OFF */
	CUR_STATUS_NORMAL = 1, /**< Everithing is OK the values read and set are OK */
	CUR_STATUS_OVERCURRENT = 2 /**< The current is upper than the set */	
}curr_status_t;
